 ...
 * 실외달리기화면
 */
public class OutdoorRunFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBackgroundImage.setImageDrawable(ContextCompat.getDrawable(Objects.requireNonNull(getContext()), R.drawable.outdoor_run_bg));

        exerciseViewModel.getTotalOutdoorRunDistance().observe(getViewLifecycleOwner(), new Observer<Float>() {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.switch_btn || view.getId() == R.id.total_distance) {
            ...
            editor.putInt(getString(R.string.pref_training_type), 1);
            editor.apply();
