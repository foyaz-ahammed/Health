...
public class TextRoundCornerProgressBar extends AnimatedRoundCornerProgressBar implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    protected void initStyleable(@NonNull Context context, @NonNull AttributeSet attrs) {
        ...
        colorEndTextProgress = typedArray.getColor(R.styleable.TextRoundCornerProgressBar_rcEndTextProgressColor, Color.WHITE);
        ...
        endTextProgress = typedArray.getString(R.styleable.TextRoundCornerProgressBar_rcEndTextProgress);
    ...
    protected void initView() {
        ...
        tvEndProgress = findViewById(R.id.tv_end_progress);
        tvEndProgress.getViewTreeObserver().addOnGlobalLayoutListener(this);
    }
    ...
    private void drawTextProgressMargin() {
        ...
        ViewGroup.MarginLayoutParams paramsEnd = (ViewGroup.MarginLayoutParams) tvEndProgress.getLayoutParams();
        params.setMargins(textProgressMargin, 0, textProgressMargin, 0);
        paramsEnd.setMargins(textProgressMargin, 0, textProgressMargin, 0);
        tvProgress.setLayoutParams(params);
        tvEndProgress.setLayoutParams(paramsEnd);
    }
...
//            }
    ...
    private void alignTextProgressInsideProgress() {
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) tvProgress.getLayoutParams();
        RelativeLayout.LayoutParams paramsEnd = (RelativeLayout.LayoutParams) tvEndProgress.getLayoutParams();
        if (isReverse()) {
            ...
            if (textInsideGravity == GRAVITY_END) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    params.addRule(RelativeLayout.ALIGN_END, R.id.layout_progress);
                    paramsEnd.addRule(RelativeLayout.ALIGN_END, R.id.layout_progress);
                }
            }
        }
        tvProgress.setLayoutParams(params);
    ...
    public void setProgressEndText(String text) {
        endTextProgress = text;
        drawTextProgress();
    }
    ...
    public void onGlobalLayout() {
        ...
        tvEndProgress.getViewTreeObserver().removeOnGlobalLayoutListener(this);
        drawTextProgressPosition();
    }
