...
public class CalendarView extends FrameLayout {
    ...
    public void updateRangeList(List<LinkedHashMap<String, java.util.Calendar>> periodList, List<LinkedHashMap<String, java.util.Calendar>> fertileList,
                                List<LinkedHashMap<String, java.util.Calendar>> predictList) {
        mDelegate.updatePeriodRangeList(periodList);
        mDelegate.updateFertileRangeList(fertileList);
        mDelegate.updatePredictRangeList(predictList);
        update();
    }
