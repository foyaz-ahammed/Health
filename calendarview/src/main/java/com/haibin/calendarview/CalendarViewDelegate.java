...
public final class CalendarViewDelegate {
    public List<LinkedHashMap<String, java.util.Calendar>> periodRangeList = new ArrayList<>();
    public List<LinkedHashMap<String, java.util.Calendar>> fertileRangeList = new ArrayList<>();
    public List<LinkedHashMap<String, java.util.Calendar>> predictRangeList = new ArrayList<>();
...
//        }
    ...
    public void updatePeriodRangeList(List<LinkedHashMap<String, java.util.Calendar>> list) {
        periodRangeList = list;
    }

    public void updateFertileRangeList(List<LinkedHashMap<String, java.util.Calendar>> list) {
        fertileRangeList = list;
    }

    public void updatePredictRangeList(List<LinkedHashMap<String, java.util.Calendar>> list) {
        predictRangeList = list;
    }
}
